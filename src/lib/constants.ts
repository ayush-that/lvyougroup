...
export const VALUES: ValueCard[] = [
  {
    ...
    description:
      "We see beyond the immediate opportunity. Our consulting approach combines deep industry expertise with forward-thinking analysis to position your business for sustainable growth in evolving markets.",
    variant: "muted",
  },
  {
    ...
    description:
      "Strategy without execution is merely theory. We bring the resources, networks, and capital to transform recommendations into results—backed by our $69M credit facility and decades of operational experience.",
    variant: "dark",
  },
  {
    ...
    description:
      "We invest alongside our clients—not just with advice, but with capital. Our transition to a family office structure reflects our commitment to long-term value creation over transactional relationships. Your success is our success.",
    variant: "cream",
  },
];
...
export const SERVICES: Service[] = [
  {
    ...
    description:
      "End-to-end consulting for payment infrastructure, digital wallets, cross-border transactions, and fintech ecosystem integration.",
  ...
  },
  {
    ...
    description:
      "Real-world blockchain applications—from supply chain transparency to tokenized assets—designed for practical business outcomes, not hype.",
  ...
  },
  {
    ...
    description:
      "Strategic advisory on precious metals investment, sourcing partnerships, and portfolio allocation for wealth preservation.",
  ...
  },
  {
    ...
    description:
      "Expert guidance on energy sector investments, trading strategies, and partnership structures in the oil and gas markets.",
    image: IMAGES.oilGas,
  },
  {
    id: "family-office",
    ...
    description:
      "For qualified opportunities, we co-invest alongside our clients—putting our capital behind our recommendations.",
  ...
  },
  {
    ...
    description:
      "High-level consulting for businesses navigating complex decisions in payments, blockchain adoption, or commodity market entry.",
...
export const CONTACT_INFO: ContactInfo = {
  ...
  phone: "+65 XXXX XXXX",
  address: ["LVyou Pte Ltd", "Singapore"],
};

export const COMPANY_DESCRIPTION =
  "A management consulting firm specializing in payment ecosystems, blockchain solutions, and commodities—backed by capital and building toward a $100M family office.";
